...
def calc_light_intensity(light_data, factor=1):
    ...
    intensity = factor * ((light_data.energy / 0.03048**-2) / (30 if is_corinth() else 300))
    
    return intensity

def calc_emissive_intensity(emissive_power, factor=1):
    intensity = factor * ((emissive_power / 0.03048**-2) / (30 if is_corinth() else 300))
    return intensity
...
def calc_light_energy(light_data, intensity, scale=0.03048):
    ...
    energy = intensity * (scale ** -2) * (30 if is_corinth() else 300)
    
    return energy

def calc_emissive_energy(light_data, intensity):
    energy = intensity * (0.03048 ** -2) * (30 if is_corinth() else 300)
    return energy
