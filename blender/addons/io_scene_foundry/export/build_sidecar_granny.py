...
class SidecarGranny:
    def __init__(self, asset_path: str, asset_name: str, asset_type: AssetType, scene_settings: NWO_ScenePropertiesGroup, corinth: bool):
