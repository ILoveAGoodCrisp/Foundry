...
class NWO_FoundryPanelProps(bpy.types.Panel):
    ...
    def draw_importer(self, box, nwo):
        ...
        if self.context.scene.nwo.asset_type == 'cinematic':
            ...
            col.operator('nwo.foundry_import', text="Import Models & Animations", icon='IMPORT').scope = 'amf,jma,jms,model,render_model,scenario,scenario_structure_bsp,particle_model,animation,prefab,structure_design,polyart_asset'
