...
class NWO_ScenePropertiesGroup(PropertyGroup):
    ...
    connected_geometry_mesh_type_planar_lightmap_region_visible: bpy.props.BoolProperty(default=True, options=set(), name="Lightmap Region", update=update_connected_geometry_mesh_type_lightmap_region_visible)
