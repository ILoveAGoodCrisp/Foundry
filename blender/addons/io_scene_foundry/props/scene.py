...
class NWO_ScenePropertiesGroup(PropertyGroup):
    ...
    def render_clean_tag_path(self, context):
        self["render_model_path"] = utils.clean_tag_path(self["render_model_path"],
            "render_model"
        ).strip('"')
    def collision_clean_tag_path(self, context):
        self["collision_model_path"] = utils.clean_tag_path(
            self["collision_model_path"],
            "collision_model"
        ).strip('"')
    def physics_clean_tag_path(self, context):
        self["physics_model_path"] = utils.clean_tag_path(
            self["physics_model_path"],
            "physics_model"
        ).strip('"')
    def animation_clean_tag_path(self, context):
        self["animation_graph_path"] = utils.clean_tag_path(
    ...
    collision_model_path : bpy.props.StringProperty(
    ...
    physics_model_path : bpy.props.StringProperty(
    ...
    animation_graph_path : bpy.props.StringProperty(
